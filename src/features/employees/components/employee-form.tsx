...
const employeeSchema = z.object({
  ...
  phoneNumber: z.string().regex(/^\d+$/, 'กรุณากรอกเฉพาะตัวเลข').min(9, 'เบอร์โทรศัพท์ต้องมีอย่างน้อย 9 หลัก'),
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent className="grid items-start gap-4 md:grid-cols-2">
          <AppFormCombobox
            ...
            required
          />
          <AppFormField name="startDate" label="วันที่เริ่มทำงาน" required>
      ...
      <Card>
        ...
        <CardContent className="grid items-start gap-4 md:grid-cols-2">
          <AppFormCombobox name="branch" label="สาขา" placeholder="เลือกสาขา" options={branchOptions} required />
          <AppFormCombobox
            name="department"
            label="แผนก"
            ...
            required
          />
          <AppFormCombobox name="role" label="บทบาทและสิทธิ" placeholder="เลือกบทบาท" options={roleOptions} required />
          <AppFormCombobox
            name="position"
            label="ตำแหน่งงาน"
...
export function EmployeeForm() {
  ...
  return (
    ...
    >
      {(form) => <EmployeeFormContent form={form} isLoading={isLoading} setIsLoading={setIsLoading} />}
    </AppForm>
  )
}
